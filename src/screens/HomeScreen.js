...
class HomeScreen extends React.Component {
  static navigationOptions = {
    header: props => {
      return <Header leftComponent={<Icon onPress={props.navigation.toggleDrawer} size={24} name={'md-menu'} style={{ color: 'white' }} />} />;
    }
  };
      ...
      <View style={styles.container}>
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.helpContainer}>
            <TouchableOpacity onPress={() => console.log('Reload pressed')} style={styles.helpLink}>
              <Text style={styles.helpLinkText}>Help, it didn’t automatically reload!</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={() => this.props.navigation.navigate('Login')} style={styles.helpLink}>
              <Text style={styles.helpLinkText}>Back to login</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
  ...
  _maybeRenderDevelopmentModeWarning() {
    if (__DEV__) {
      const learnMoreButton = (
        <Text onPress={() => console.log('learn more pressed')} style={styles.helpLinkText}>
          Learn more
        </Text>
      );
